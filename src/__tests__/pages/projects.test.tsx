...
describe('Projects page', () => {
    ...
    it('renders external links', () => {
        render(<Projects />);
        expect(screen.getByText('www.segmantics.com')).toHaveAttribute('href', 'http://www.segmantics.com');
        expect(screen.getByText('www.aquacars.co.uk')).toHaveAttribute('href', 'http://www.aquacars.co.uk');
    });
});
