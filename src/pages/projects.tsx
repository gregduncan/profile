  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="U.I and software development specialist – View latest projects. Greg Duncan U.I Developer."
        ></meta>
      </Head>
      <div className="page">
            ...
            <div className="project full">
              <div className="row">
                ...
                <div className="col-md-7">
                  <h3>Segmantics</h3>
                  <p>
                    The world's first software as a service risk management webapp. Built as a
                    single page application, MVC5, Knockout.js, Web API, Require.js and Grunt.
                    Integrated unit testing with Jasmine. SignalR, Bootstrap and Angular.js also
                    included. Open authentication with Facebook, Google, Twitter and LinkedIn.
                  </p>
            ...
            <div className="project full">
              <div className="row">
                ...
                <div className="col-md-7">
                  <h3>Aqua Cars</h3>
                  <p>
                    Both Mobile and Desktop applications for the UK's third largest taxi company
                    were built using HTML5, CSS3 and jQuery. The cross platform mobile website built
                    in jQuery Mobile and gives the full functionality of a native app but with
                    higher accessibility. Servers side the applications use .NET Webmatrix
                    infrastructure.
                  </p>
