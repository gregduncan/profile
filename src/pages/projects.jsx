                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="project full">
                            <div className="row">
                                <div className="col-md-5">
                                    <div className="project-image project-easyoffice"></div>
                                </div>
                                <div className="col-md-7">
                                    <h3>Easy Office</h3>
                                    <p>
                                        A custom white label system built to expand EasyOffice global office database. The project involved upgrading existing technology to work within new ASP.NET
                                        frameworks. The website is designed in VB.NET, SQL, HTML4 and CSS2. The project involved heavy front end development.
                                    </p>
                                    <a className="external" target="_blank" href="http://www.easyoffice.co.uk">
                    ...
                    <div className="col-md-6">
                        <div className="project full">
                            <div className="row">
                                <div className="col-md-5">
                                    <div className="project-image  project-grc"></div>
                                </div>
                                <div className="col-md-7">
                                    <h3>Level 2 GRC</h3>
                                    <p>
                                        An original and collaborative project, this application was built using complex SQL 2008 stored procedures, ASP.NET 3.5, C# 3.5, HTML5 and CSS2. The software
                                        implements a number of JavaScript libraries including jQuery. Windows Services, Web Services, and XML are used throughout.
                                    </p>
                                    <a className="external" target="_blank" href="http://www.level2grc.com">
                                        www.level2grc.com
                                    </a>
                                </div>
                            </div>
                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="project full">
                            <div className="row">
                                <div className="col-md-5">
                                    <div className="project-image project-ethnicraft"></div>
                                </div>
                                <div className="col-md-7">
                                    <h3>Ethnicraft</h3>
                                    <p>
                                        Built using the latest .NET Webmatrix technology in C#4.0, Ethnicraft for Trading Boundaries has a fully customised CMS system for sales and product management.
                                        The website backend utilises .NET Dynamic Data infrastructure, for fast robust development. Client side jQuery is used throughout to produce a slick responsive
                                        interface with HTML5 and CSS3.
                                    </p>
                                    <a className="external" target="_blank" href="http://ethnicraft.tradingboundaries.com">
                                        www.ethnicraft.com
                                    </a>
                                </div>
                            </div>
                    ...
                    <div className="col-md-6">
                        <div className="project full">
                            <div className="row">
                                <div className="col-md-5">
                                    <div className="project-image project-partybelles"></div>
                                </div>
                                <div className="col-md-7">
                                    <h3>The Party Belles</h3>
                                    <p>
                                        A bespoke CMS system was built in .NET 3.5 to give full control of website content to site administrators. The GUI utilises .NET Ajax and jQuery. The
                                        application revolves around an MS SQL database fully incorporated into a nTier development architecture.
                                    </p>
                                    <a className="external" target="_blank" href="http://www.thepartybelles.co.uk">
