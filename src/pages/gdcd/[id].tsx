  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={`U.I and software development specialist – View GDCD from GDCD${yearId}. Greg Duncan U.I Developer.`}
        ></meta>
      </Head>
        ...
        <div id="listing">
          <Toggle visible={yearId === '2013'}>
            ...
            <div className="row">
              <div className="col-md-12">
                <a
                  href="http://open.spotify.com/user/gregduncan/playlist/7xAfI24YbblgfzBE0l7ZSZ"
                  target="_blank"
                  className="spotify"
          ...
          <Toggle visible={yearId === '2012'}>
            ...
            <div className="row">
              <div className="col-md-12">
                <a
                  href="http://open.spotify.com/user/gregduncan/playlist/6krGL1lbLEyPkwIJhoAvfc"
                  target="_blank"
                  className="spotify"
                  title="Open in Spotify"
                ></a>
          ...
          <Toggle visible={yearId === '2011'}>
            ...
            <div className="row">
              <div className="col-md-12">
                <a
                  href="http://open.spotify.com/user/gregduncan/playlist/1VKQ2axFl8duTtWuCCwhI4"
                  target="_blank"
                  className="spotify"
                  title="Open in Spotify"
                ></a>
          ...
          <Toggle visible={yearId === '2010'}>
            ...
            <div className="row">
              <div className="col-md-12">
                <a
                  href="http://open.spotify.com/user/gregduncan/playlist/2kCrd7rty66TDrxAZMjhda"
                  target="_blank"
                  className="spotify"
                  title="Open in Spotify"
                ></a>
          ...
          <Toggle visible={yearId === '2009'}>
            ...
            <div className="row">
              <div className="col-md-12">
                <a
                  href="http://open.spotify.com/user/gregduncan/playlist/3jYFNFpYEoprzasmYlvXDK"
                  target="_blank"
                  className="spotify"
                  title="Open in Spotify"
                ></a>
